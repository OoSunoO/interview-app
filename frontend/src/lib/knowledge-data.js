 ...
 * Content fields contain real extracts from JavaGuide pages (web-extracted).
 *
 * Each entry: { title, content, source: { url, title } | null }
 * - content: local summary extracted from JavaGuide (markdown)
...
📖 完整阅读：https://javaguide.cn/java/basis/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/java/collection/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/java/jvm/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/java/concurrent/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/java/io/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/system-design/framework/spring/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/cs-basics/operating-system/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/cs-basics/network/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/database/mysql/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/database/redis/`,
    source: {
...
📖 完整阅读：https://javaguide.cn/tools/docker/`,
    source: {
